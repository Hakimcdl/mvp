    ...
    <footer class="bg-secondary d-flex justify-content-around align-items-center py-3">
        <nav class="col-3 ">
            <ul class="list-group text-center col-6 mx-auto">
                ...
                <a class="list-group-item text-light bg-secondary" href="#">account</a>
                <a class="list-group-item text-light bg-secondary" href="#">shop</a>
            </ul>
        </nav>
        <div class="col-3">
            <a class="d-flex justify-content-center" href="/"><img src="assets/img/logomvp.jpg" alt="logo"></a>
        </div>
        <div class="col-3">
